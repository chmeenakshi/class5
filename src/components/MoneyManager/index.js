...
function MoneyManager() {
  ...
  return (
    <div className="app-container555">
      <div className="responsive-container55">
        <div className="header-container56">
          <h1 className="heading">Hi, Meena</h1>
        ...
        <div className="transaction-details">
          <form className="transaction-form" onSubmit={onAddTransaction}>
            ...
            <label className="input-label5" htmlFor="title">
              TITLE
            </label>
            <input
              type="text"
              ...
              placeholder="TITLE"
            />
            <label className="input-labe" htmlFor="amount">
              AMOUNT
            </label>
            <input
              type="text"
